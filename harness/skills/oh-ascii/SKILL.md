...
Architecture diagrams for docs, sequence/class/flowcharts as ASCII, box-drawing alignment validation, blast radius/swimlane/timeline/progress visualizations, file trees with change metadata, before/after comparisons.
