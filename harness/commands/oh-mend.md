---
description: Fix build errors (--lang=rust|go|cpp|java|kotlin)
agent: oh-mender
subtask: true
---
...
- `--lang=rust|go|cpp|java|kotlin` — Route to language-specific build fixer
- Without `--lang`, auto-detects build system from project files
