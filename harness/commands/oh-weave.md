---
description: Orchestrate agents or eval (--eval)
agent: oh-blueprinter
subtask: true
---

# Orchestrate Command

Orchestrate multiple specialized agents for complex tasks, or evaluate implementation.

## Flags

- `--eval` — Evaluate implementation against acceptance criteria (absorbed from oh-gauge)
