...
| # | Section | Load When |
|---|---------|-----------|
| 01 | [Brainstorm (Mode A)](../skills/oh-planner/sections/01-brainstorm.md) | Concept is vague ("what if", "I have an idea") — shape into structured design doc |
| 02 | [Architecture Analysis (Mode B)](../skills/oh-planner/sections/02-architecture-analysis.md) | Codebase feels messy, need surface understanding before planning |
| 03 | [Structured Plan (Mode C)](../skills/oh-planner/sections/03-structured-plan.md) | Requirements exist and need formal plan document with phases and verification |
| 04 | [Autoplan (Mode D)](../skills/oh-planner/sections/04-autoplan.md) | Existing plan needs comprehensive automated review, auto-decide routine questions |
| 05 | [Plan Artifact Format](../skills/oh-planner/sections/05-plan-artifact.md) | Writing or updating a plan — use this template and storage convention |
